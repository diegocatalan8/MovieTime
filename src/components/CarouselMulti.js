...
import {View, StyleSheet, Image, Dimensions, TouchableWithoutFeedback, TouchableWithoutFeedbackBase} from "react-native";
...
function RenderItem(props){
    ...
    imageUrl = `${BASE_PATH_IMG}/w500${poster_path}`;
    const onNavigation = () =>{
